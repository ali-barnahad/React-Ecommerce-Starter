      ...
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center">
          ...
          <div className="lg:flex hidden w-full max-w-[500px]">
            ...
            />
            <div
              className="bg-blue-500 text-white text-xs text-[26px] grid place-items-center px-4 cursor-pointer"
          ...
          <div className="flex gap-4 md:gap-8 items-center">
            ...
            >
              ...
              <div
                className="absolute top-[-15px] right-[-10px] bg-red-600 w-[25px] h-[25px] rounded-full text-white text-xs text-[14px] grid place-items-center"
...
export default Navbar; // Exportieren der Navbar-Komponente
